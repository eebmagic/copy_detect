...
#		lower the color resolution
#		if two images have identical resolution:
#			check through each pixel value for matches
#		if more matches than threshold:
#			declare a match
##################################################
